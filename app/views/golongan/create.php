...
<html lang="en" class="ms-5 me-5">
    ...
    <body>
        ...
        <div class="container-fluid w-100 border-start border-end border-bottom py-4 align-middle" style="height:600px">
            <h3 class="mb-5">Tambah Golongan</h3>
            <form action="<?php echo URL; ?>/golongan/store" method="post" class="row g-3" class="text-center">
                <div class="">
                    <label class="form-label">Nama Golongan</label>
                    <input type="text" class="form-control w-25" placeholder="Nama Golongan" name="gol_nama" required>
                </div>
                <div class="">
                    <label class="form-label">Kode Golongan</label>
                    <input type="text" class="form-control w-25" placeholder="Kode Golongan" name="gol_kode" required>
                </div>
                <div class="col-12">
