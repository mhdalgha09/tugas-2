...
<html lang="en" class="ms-5 me-5">
    ...
    <body>
        ...
        <a href="<?php echo URL; ?>/pelanggan/create" class="btn btn-secondary mb-2 float-end">Tambah Pelanggan</a>
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td class="text-center" style="width:50px;"><a href="<?= URL; ?>/pelanggan/edit/<?= $row['pel_id']; ?>" class="badge text-bg-warning text-decoration-none">Edit</a></td>
